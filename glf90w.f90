module glf90w
    ...
    integer, parameter :: GLFW_TRUE  = 1
    integer, parameter :: GLFW_FALSE = 0

    integer, parameter :: GLFW_RELEASE        = 0
    integer, parameter :: GLFW_PRESS          = 1
    integer, parameter :: GLFW_REPEAT         = 2
    integer, parameter :: GLFW_HAT_CENTERED   = 0
    integer, parameter :: GLFW_HAT_UP         = 1
    integer, parameter :: GLFW_HAT_RIGHT      = 2
    integer, parameter :: GLFW_HAT_DOWN       = 4
    integer, parameter :: GLFW_HAT_LEFT       = 8
    integer, parameter :: GLFW_HAT_RIGHT_UP   = ior(GLFW_HAT_RIGHT, GLFW_HAT_UP)
    integer, parameter :: GLFW_HAT_RIGHT_DOWN = ior(GLFW_HAT_RIGHT, GLFW_HAT_DOWN)
    integer, parameter :: GLFW_HAT_LEFT_UP    = ior(GLFW_HAT_LEFT , GLFW_HAT_UP)
    integer, parameter :: GLFW_HAT_LEFT_DOWN  = ior(GLFW_HAT_LEFT , GLFW_HAT_DOWN)
